<div class="container">
	<div class="section-title">
		<h2 data-aos="fade-down" class="bg-title-section text-white bg-primary px-3 py-2 mb-5"><?php esc_html_e('Why trust us', 'zinoviev-school'); ?></h2>
	</div>
	<div class="row">
		<div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
			<div data-aos="zoom-in-up" class="border border-primary border-3 bg-white d-flex flex-column h-100 p-5">
